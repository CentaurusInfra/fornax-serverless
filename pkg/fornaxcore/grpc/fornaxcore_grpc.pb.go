...
type FornaxCoreServiceClient interface {
	GetMessage(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (FornaxCoreService_GetMessageClient, error)
	PutMessage(ctx context.Context, in *FornaxCoreMessage, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *fornaxCoreServiceClient) GetMessage(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (FornaxCoreService_GetMessageClient, error) {
...
func (c *fornaxCoreServiceClient) PutMessage(ctx context.Context, in *FornaxCoreMessage, opts ...grpc.CallOption) (*emptypb.Empty, error) {
...
type FornaxCoreServiceServer interface {
	GetMessage(*emptypb.Empty, FornaxCoreService_GetMessageServer) error
	PutMessage(context.Context, *FornaxCoreMessage) (*emptypb.Empty, error)
...
func (UnimplementedFornaxCoreServiceServer) GetMessage(*emptypb.Empty, FornaxCoreService_GetMessageServer) error {
	return status.Errorf(codes.Unimplemented, "method GetMessage not implemented")
}
func (UnimplementedFornaxCoreServiceServer) PutMessage(context.Context, *FornaxCoreMessage) (*emptypb.Empty, error) {
