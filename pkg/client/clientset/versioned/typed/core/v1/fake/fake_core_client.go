...
import (
	v1 "centaurusinfra.io/fornax-serverless/pkg/client/clientset/versioned/typed/core/v1"
...
func (c *FakeCoreV1) Applications(namespace string) v1.ApplicationInterface {
