...
var _ server.PodMonitor = &integPodMonitor{}

type integPodMonitor struct {
	sync.RWMutex
...
func (*integPodMonitor) OnUpdate(msgDispatcher server.MessageDispatcher, ctx context.Context, message *grpc.FornaxCoreMessage) error {
...
func NewIntegPodMonitor(checkPeriod time.Duration) *integPodMonitor {
	return &integPodMonitor{
